...
public class NEBlocks {
    ...
    public static final Block SANDSTONE_TATER = createTaterBlock(Blocks.SANDSTONE, "dee6a6e0c3521db9b0279d4d5a11f009e196cfe6e1f5babf1e09d99f5c48ba13");public static final Block SNOW_FOX_TATER = createTaterBlock(ParticleTypes.HEART, "bd1d473e3e82d0afca0f7568748f0ff637334632cfb5f6ac228533fadf9bbbf5");
    ...
    private static Block createElderGuardianParticleTaterBlock(String texture) {
        return new CubicPotatoBlock(createTaterBlockSettings(), ParticleTypes.SOUL_FIRE_FLAME, texture);
    }
